    ...
    <>
      ...
      <Card style={jobcard}>
        <Card.Body>
          ...
          <Card.Text>
            Make the experience memorable with your photgraphy skills.
          </Card.Text>
      ...
      <Card style={jobcard}>
        <Card.Body>
          ...
          <Card.Subtitle className="mb-2 text-muted">Make experience of the customer memorable</Card.Subtitle>
          <Card.Text>
